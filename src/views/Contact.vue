<template>
  <v-card class="mx-auto" color="white" max-width="1500" elevation="0">
    ...
    <p><a href="https://www.linkedin.com/in/kensuke-mitsuzawa-134a728b/" target="_blank">Linkedin</a></p>
    <p><a href="https://github.com/Kensuke-Mitsuzawa" target="_blank">Github</a></p>
      </div>
      </v-card>
</template>
