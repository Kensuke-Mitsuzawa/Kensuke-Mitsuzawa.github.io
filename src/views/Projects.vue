        ...
        <v-flex text-center lg4 sm12 xs12>
          <v-card color="white" elevation="0">
            <p class="text-h5 text-decoration-underline">News distribution system</p>
              ...
              <p>
                The project team would like to send news text automatically depending on preference of their readers.
          ...
          <v-card color="white" max-width="1500" elevation="0">
              ...
              <p>
                The project team would like to know topics in a society. They could utilize the topics for their analysis-works.
          ...
          <v-card color="white" max-width="1500" elevation="0">
              ...
              <p>
                The project team publishes news text everyday. The news text is normally long, therefore, it takes to time to read throughout.
          ...
          <v-card color="white" max-width="1500" elevation="0">
              ...
              >Entity extraction from review texts</p>
              <p class="text-h6 font-italic">nondisclosure</p>
